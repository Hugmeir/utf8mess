...
Historically, things like C<$::::'foo> and C<$foo::'bar> were legal, but
C<$::'::foo> and C<$foo'::bar> were not.  This was changed in 5.18 to 
a simple rule: in each separator, you can use either one pair of colons,
or one single quote.
